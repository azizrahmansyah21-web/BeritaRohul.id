                        ...
                        <div class="carousel-inner">
                            @foreach ($post->images as $postImage)
                                <div class="carousel-item {{ $loop->index == 0 ? 'active' : ' ' }}">
                                    <img src="{{ asset('uploads/' . $postImage->image) }}" class="d-block w-100" alt="First Slide">
                        ...
                        <div class="comments" style="position: relative;">
                            @foreach($post->comments as $comment)
                                <div class="comment" id="display_comment_{{ $comment->id }}" data-comment-id="{{ $comment->id }}" style="position: relative; padding-right: 30px;">
                                    <img src="{{ asset('uploads/' . $comment->user->image) }}" alt="User Image" class="comment-img" />
                    ...
                    <div class="sn-related">
                        ...
                        <div class="row sn-slider">
                            @foreach($relatedPosts as $relatedPost)
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        <img src="{{ asset('uploads/' . $relatedPost->images->first()->image) }}" class="img-fluid" alt="{{ $relatedPost->title }}" />
                                        <div class="sn-title">
                        ...
                        <div class="sidebar-widget">
                            ...
                            @foreach ($relatedPosts as $relatedPost)
                                <div class="news-list">
                                    <div class="nl-item">
                                        <div class="nl-img">
                                            <img src="{{ asset('uploads/' . $relatedPost->images->first()->image) }}" />
                                        </div>
                                        <div class="nl-title">
                                            <a href="{{ route('frontend.post.show', $relatedPost->slug) }}">{{ $relatedPost->title }}</a>
                                        </div>
                                ...
                                <div class="tab-content">
                                    <div id="featured" class="container tab-pane active">
                                        @foreach ($latestCachedPosts as $latestCachedPost)
                                            <div class="tn-news">
                                                <div class="tn-img">
                                                    <img src="{{ asset('uploads/' . $latestCachedPost->images->first()->image) }}" />
                                                </div>
                                                <div class="tn-title">
                                    ...
                                    <div id="popular" class="container tab-pane fade">
                                        @foreach($cachedPopularPosts as $cachedPopularPost)
                                            <div class="tn-news">
                                                <div class="tn-img">
                                                    <img src="{{ asset('uploads/' . $cachedPopularPost->images->first()->image) }}" />
                                                </div>
                                                <div class="tn-title">
