        ...
        <div class="main-content">
            ...
            <section id="profile" class="content-section active">
                ...
                <div class="user-profile mb-3">
                    ...
                    @endphp
                    <img src="{{ $auth_user->provider_id ? $auth_user->image : asset('uploads/' . $auth_user->image) }}" alt="User Image"
                           ...
                           @forelse ($posts as $post)
                                <div class="post-item mb-4 p-3 border rounded">
                                    <div class="post-header d-flex align-items-center mb-2">
                                        <img src="{{ $auth_user->provider_id ? $auth_user->image : asset('uploads/' . $auth_user->image) }}" alt="User Image" class="rounded-circle"
                                    ...
                                    <div id="newsCarousel" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            @foreach($post->images as $image)
                                                ...
                                                <img src="{{ asset('uploads/' . $image->image) }}" class="d-block w-100"
                                                        alt="First Slide">
